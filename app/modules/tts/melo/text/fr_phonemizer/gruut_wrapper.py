...
if __name__ == "__main__":
    ...
    with open(os.path.join(cur_dir, 'french_symbols.txt'), 'w', encoding="utf-8") as g:
        g.writelines(symbols + not_existed_sym)
        
    with open(os.path.join(cur_dir, 'example_ipa.txt'), 'w', encoding="utf-8") as g:
        g.writelines(phonemes)

    data = {'symbols': symbols + not_existed_sym}

    with open(os.path.join(cur_dir, 'fr_symbols.json'), 'w', encoding="utf-8") as f:
