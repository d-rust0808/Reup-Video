...
try:
    from transformers4576 import GPT2Config, GPT2Model, DynamicCache  # pyright: ignore[reportMissingImports]
    from transformers4576.modeling_utils import PreTrainedModel  # pyright: ignore[reportMissingImports]
    from transformers4576.generation import GenerationMixin  # pyright: ignore[reportMissingImports]
    from transformers4576.modeling_outputs import CausalLMOutputWithCrossAttentions  # pyright: ignore[reportMissingImports]
    from transformers4576.configuration_utils import PretrainedConfig  # pyright: ignore[reportMissingImports]
except ImportError:
    from transformers import GPT2Config, GPT2Model, DynamicCache
