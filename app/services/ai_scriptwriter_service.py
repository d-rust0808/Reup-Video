...
class AIScriptwriterService:
    ...
    def localize_script(
        ...
        system_prompt = (
            ...
            "với draft_translation (nếu có), rồi viết lại bằng ngôn ngữ đích thật tự nhiên, chuẩn điện ảnh và đúng diễn biến.\n\n"
            "QUY TẮC BẮT BUỘC:\n"
            "1. BẢO TOÀN 100% NỘI DUNG & Ý NGHĨA (KHÔNG CẮT XÉN):\n"
            "   - Giữ nguyên toàn bộ tình tiết, sự kiện, quan hệ nhân quả, tên riêng, con số, phủ định và ý định người nói.\n"
            "   - TUYỆT ĐỐI CẤM cắt xén, lược bỏ bớt ý hoặc tóm tắt làm mất nội dung hội thoại.\n"
            "   - Diễn đạt bằng tiếng Việt cô đọng, gãy gọn, súc tích, lược bỏ các từ thừa rườm rà để số từ gần với recommended_words, giúp giọng đọc khớp chuẩn xác với khung thời gian của video.\n"
            "   - ASR có thể nhận diện tách mảnh câu hoặc sai từ đồng âm. Hãy dựa vào ngữ cảnh các câu trước/sau để khôi phục câu hoàn chỉnh, mạch lạc; không dịch word-by-word máy móc.\n"
            "   - Mỗi translated_text phải là một câu/vế hoàn chỉnh có nghĩa, cấm các từ vụn vô nghĩa.\n"
            ...
            "3. XƯNG HÔ ĐÚNG NGỮ CẢNH ĐIỆN ẢNH:\n"
