        ...
        <table className="w-full text-left border-collapse text-xs">
          <thead>
            <tr className="bg-slate-50 text-slate-600 font-bold border-b border-slate-200">
              <th className="px-4 py-3.5">Mã Job ID</th>
              <th className="px-4 py-3.5">Sàn Video</th>
              <th className="px-4 py-3.5">Trạng Thái</th>
              <th className="px-4 py-3.5">Tiến Độ Live</th>
              <th className="px-4 py-3.5">Nhật Ký Gần Nhất</th>
            ...
            {loading ? (
              ...
              jobs.map((job) => {
                ...
                return (
                  ...
                  >
                    <td className="px-4 py-3.5 font-mono font-bold text-slate-900 flex items-center gap-1.5">
                      {isSelected && <span className="w-2 h-2 rounded-full bg-blue-600 animate-pulse" />}
                      {job.job_id}
                    </td>
                    <td className="px-4 py-3.5 uppercase font-bold text-slate-600">{job.platform || 'douyin'}</td>
                    ...
                    <td className="px-4 py-3.5 w-48">
                      <div className="space-y-1">
                        ...
                        <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden border border-slate-200">
                          <div
                            className="bg-blue-600 h-full transition-all duration-300 rounded-full shadow-xs"
                            style={{ width: `${progressPct}%` }}
                          />
                        </div>
                      </div>
                    </td>
                    <td className="px-4 py-3.5 font-mono text-[11px] text-slate-600 truncate max-w-xs">
                      {job.message || job.log || '—'}
                    </td>
